        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          animationDelay: `${index * 0.1}s`
              ...
              <div className="relative overflow-hidden">
                <img src={service.image} alt={`${service.title} service demonstration`} className="w-full h-64 object-cover transition-transform duration-300 group-hover:scale-105" />
