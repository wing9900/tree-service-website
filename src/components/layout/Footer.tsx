              ...
              <div className="mt-4 pt-4 border-t border-primary-foreground/20">
                ...
                <div className="flex gap-3">
                  ...
                  <a href="{{YELP_URL}}" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors" aria-label="Yelp">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M21.111 18.226c-.141.969-2.119 3.483-3.029 3.641-.311.053-.619-.011-.883-.189-.265-.177-.463-.47-.463-.777 0-.234.177-.73.454-1.315.278-.584.601-1.318.892-1.897.266-.528.453-1.177.596-1.636.134-.432.177-.691.177-.691s.32-.184.684-.05c.387.143.55.479.572.914zm-7.664 4.111c-.656 1.002-1.905 1.599-2.897 1.599-.992 0-1.828-.621-2.361-1.623-.533-1.002-.533-2.347.133-3.483.666-1.136 1.77-1.779 2.895-1.779s2.229.643 2.895 1.779c.666 1.136.666 2.481.335 3.507zm6.658-8.182c-.089.744-.577 2.313-1.023 2.863-.159.196-.398.307-.619.307-.221 0-.442-.111-.619-.307-.177-.196-.265-.49-.265-.777 0-.287.088-.581.265-.777.446-.55.934-2.119 1.023-2.863.089-.744.177-1.315.354-1.636.177-.321.398-.537.707-.537s.53.216.707.537c.177.321.265.892.47 2.19z"/>
                    </svg>
                  </a>
                </div>
              </div>
