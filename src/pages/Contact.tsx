            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                ...
                <div className="flex gap-4">
                  ...
                  >
                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2.25c-.53 0-1.05.01-1.56.03-5.23.23-9.21 4.56-9.21 9.97s3.98 9.74 9.21 9.97c.51.02 1.03.03 1.56.03s1.05-.01 1.56-.03c5.23-.23 9.21-4.56 9.21-9.97s-3.98-9.74-9.21-9.97c-.51-.02-1.03-.03-1.56-.03zm0 .75c.48 0 .95.01 1.42.03 4.67.21 8.33 4.07 8.33 8.72s-3.66 8.51-8.33 8.72c-.47.02-.94.03-1.42.03s-.95-.01-1.42-.03c-4.67-.21-8.33-4.07-8.33-8.72s3.66-8.51 8.33-8.72c.47-.02.94-.03 1.42-.03zm0 2.75c-3.45 0-6.25 2.8-6.25 6.25s2.8 6.25 6.25 6.25 6.25-2.8 6.25-6.25-2.8-6.25-6.25-6.25zm0 .75c3.04 0 5.5 2.46 5.5 5.5s-2.46 5.5-5.5 5.5-5.5-2.46-5.5-5.5 2.46-5.5 5.5-5.5zm-2.25 2.5l1.5 3 3-1.5-1.5 3 3 1.5-3 1.5 1.5 3-1.5-3-3 1.5 3-1.5-1.5-3 1.5 3z"/>
                    </svg>
                  </a>
                </div>
              </div>
