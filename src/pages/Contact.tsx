            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                ...
                <div className="flex gap-4">
                  ...
                  >
                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M21.111 18.226c-.141.969-1.269 1.332-1.928 1.332-.524 0-1.067-.15-1.541-.513-1.787-1.367-4.529-3.461-4.529-5.093 0-1.632 1.633-2.777 3.615-2.777 1.982 0 3.615 1.145 3.615 2.777 0 1.632-2.742 3.726-4.529 5.093-.474.363-1.017.513-1.541.513-.659 0-1.787-.363-1.928-1.332L21.111 18.226zM12.168 21.286c-.097.484-.484.704-.947.704s-.85-.22-.947-.704l-1.826-9.129c-.097-.484.17-.899.654-.899.484 0 .751.415.654.899l1.465 7.303 1.465-7.303c-.097-.484.17-.899.654-.899.484 0 .751.415.654.899L12.168 21.286zM7.168 15.286c-.362.334-.798.484-1.238.484-.881 0-1.673-.581-1.673-1.482 0-.901.792-1.482 1.673-1.482.44 0 .876.15 1.238.484l3.794 3.496c.362.334.529.798.529 1.238 0 .881-.547 1.673-1.448 1.673-.901 0-1.448-.792-1.448-1.673 0-.44.167-.904.529-1.238L7.168 15.286z"/>
                    </svg>
                  </a>
                </div>
              </div>
